...
enum {
	MT76X0U_STATE_INITIALIZED,
	MT76X0U_STATE_REMOVED,
	MT76X0U_STATE_WLAN_RUNNING,
	MT76X0U_STATE_MCU_RUNNING,
	MT76X0U_STATE_SCANNING,
	MT76X0U_STATE_READING_STATS,
	MT76X0U_STATE_MORE_STATS,
};
 ...
 * @tx_lock:		protects @tx_q and changes of MT76X0U_STATE_*_STATS
 *			flags in @state.
...
bool mt76_poll(struct mt76x0_dev *dev, u32 offset, u32 mask, u32 val,
	       int timeout);
bool mt76_poll_msec(struct mt76x0_dev *dev, u32 offset, u32 mask, u32 val,
		    int timeout);
...
static inline u32 mt76_rr(struct mt76x0_dev *dev, u32 offset)
{
	return mt76x0_rr(dev, offset);
}

static inline void mt76_wr(struct mt76x0_dev *dev, u32 offset, u32 val)
{
	return mt76x0_wr(dev, offset, val);
}

static inline u32
mt76_rmw(struct mt76x0_dev *dev, u32 offset, u32 mask, u32 val)
{
	return mt76x0_rmw(dev, offset, mask, val);
}

static inline u32 mt76_set(struct mt76x0_dev *dev, u32 offset, u32 val)
{
	return mt76_rmw(dev, offset, 0, val);
}

static inline u32 mt76_clear(struct mt76x0_dev *dev, u32 offset, u32 val)
{
